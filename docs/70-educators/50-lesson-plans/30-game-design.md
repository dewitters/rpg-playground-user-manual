...
RPG Playground provides a comprehensive foundation in game design, equipping students with the skills needed to create engaging and well-designed games, with a big focus on narrative.
...
- **Nonlinear storytelling**: Create complex storylines with branching paths. This helps in understanding how choices and consequences affect the player’s experience and the overall narrative flow.


### Game Mechanics and Systems Design

- **Understanding Game Mechanics**: Learning how different game mechanics (e.g., combat, exploration, puzzles, inventory) work and how they interact.
...
- **Puzzle and Challenge Design**: Create puzzles and challenges, learning how to balance difficulty and provide satisfying solutions without frustrating the player.
...
Students can learn how to create engaging and well-structured levels. They can experiment with pacing, difficulty curves, and player guidance within a controlled environment.
...
Event and Trigger Systems: Learning to use event and trigger systems helps students understand cause-and-effect relationships within games, essential for creating interactive and dThese tools allow students to cynamic game environments.
...
The ease of use and rapid development cycle in these tools encourage students to prototype ideas quickly and iterate on them. This teaches the importance of testing and refining game elements based on feedback.
...
There are several important concepts in game design that help create engaging and well-structured gameplay experiences.


### Gating

Only allow the player to progress if they have completed a task or answered a question correctly.

Gates are used to control player progression by blocking access to certain areas or features until specific conditions are met. These conditions can include completing a quest, acquiring a key item, defeating a boss, or solving a puzzle.
...
- Resource Collection: Requiring a certain amount of resources to progress (e.g., collecting a number of items or currency).
...
- Environmental Obstacles: Physical barriers that require specific actions or items to overcome (e.g., locked doors, blocked paths).


<!-- Not really possible *yet* in RPG Playground --

### Checkpoints
Points within a level where the player's progress is saved.
...
Items, abilities, or content that become available after meeting certain conditions.
...
Concealing parts of the game map until the player explores them.
...
Challenging enemies or encounters that serve as significant milestones.
...
Concealed routes or items that players can discover.
...
A branching system where players can unlock new skills or abilities.
...
Tasks or objectives that must be completed within a set time limit.
...
Branching conversation options that affect outcomes and relationships.
...
Series of interconnected quests that must be completed in sequence.
...
Items scattered throughout the game world that players can gather.
...
Locations that allow players to quickly travel between areas.
...
Adapting the game's difficulty based on the player's performance.
